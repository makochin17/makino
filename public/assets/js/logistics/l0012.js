...
$(function(){
    ...
    $('input[id^=form_select]').on('change', function(e) {
        ...
        if (!prop) {
            ...
            $('#select_id').val(location_ids);
            $('#form_select_'+listno).val(location_id).prop("checked", false);
        } else {
            location_ids.push(location_id);
            $('#select_id').val(location_ids);
            $('#form_select_'+listno).val(location_id).prop("checked", true);
        }
    ...
    // 出庫時間
    $('input[id^=delivery_time]').on('change', function(e) {
