...
function change() {
    ...
    document.entryForm.product_code_text.disabled = flag;
}
...
function submitChkExecution() {
    ...
    // hiddenに商品コードコピー
    document.entryForm.product_code.value = document.entryForm.product_code_text.value;
    
    return flag;
}

// 検索ボタン押下時処理
function productSearch(url_str) {
    var callback_id = 'callback_m0060'; //IDをふる
