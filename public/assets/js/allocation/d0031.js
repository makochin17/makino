...
// 編集ボタン押下時処理
function onEdit(url_str, sales_correction_number) {
    var f = document.forms["searchForm"];
    f.processing_division.value = '2';
    f.sales_correction_number.value = sales_correction_number;
...
// 削除ボタン押下時処理
function onDelete(sales_correction_number) {
	//削除確認
	var sales_correction_number_p = ('0000000000' + sales_correction_number).slice(-10);
	var flag = window.confirm(processing_msg1.replace('XXXXX', sales_correction_number_p));
