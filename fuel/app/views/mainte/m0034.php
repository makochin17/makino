			...
			<table class="search-area" style="height: 90px; width: 780px">
				<tr>
					...
					<td style="width: 480px; height: 30px;">
                        <?php echo Form::radio('carrier_radio', 1, $data['carrier_radio'] != '2', 
                        array('id' => 'form_carrierR1', 'onchange' => 'change(this)')); ?>
                        <?php echo Form::label('自動採番', 'carrierR1'); ?>
                        <br />
                        <?php echo Form::radio('carrier_radio', 2, $data['carrier_radio'] == '2', 
                        array('id' => 'form_carrierR2', 'onchange' => 'change(this)')); ?>
                        <?php echo Form::label('指定', 'carrierR2'); ?>
                        &emsp;
	                    <?php echo Form::input('text_carrier_code', (!empty($data['carrier_code'])) ? $data['carrier_code'] : '', 
	                    array('class' => 'input-text', 'type' => 'text', 'id' => 'text_carrier_code', 'style' => 'width:100px;', 'minlength' => '1', 'maxlength' => '5', 'tabindex' => '5')); ?></td>
...
<!--				<tr>
				...
				<tr>
					...
					<td style="width: 480px; height: 30px;">
                        <?php echo Form::label((!empty($data['carrier_company_name'])) ? $data['carrier_company_name']:'', 'carrier_company_name', array('style' => 'display:inline;')); ?>
                        <?php echo Form::hidden('carrier_company_name', (!empty($data['carrier_company_name'])) ? $data['carrier_company_name'] : '');?>
					</td>
				</tr>
<!--				<tr>
					<td style="width: 140px; height: 30px;">
				...
				<tr>
					...
					<td style="width: 480px; height: 30px;">
                        <?php echo Form::label((!empty($data['carrier_sales_office_name'])) ? $data['carrier_sales_office_name']:'', 'carrier_sales_office_name', array('style' => 'display:inline;')); ?>
	                    <?php echo Form::hidden('carrier_sales_office_name', (!empty($data['carrier_sales_office_name'])) ? $data['carrier_sales_office_name'] : '');?>
					</td>
				</tr>
<!--				<tr>
					<td style="width: 140px; height: 30px;">
				...
				<tr>
					...
					<td style="width: 480px; height: 30px;">
                        <?php echo Form::label((!empty($data['carrier_department_name'])) ? $data['carrier_department_name']:'', 'carrier_department_name', array('style' => 'display:inline;')); ?>
	                    <?php echo Form::hidden('carrier_department_name', (!empty($data['carrier_department_name'])) ? $data['carrier_department_name'] : '');?>
					</td>
				</tr>
				<tr>
					<td style="width: 140px; height: 30px;">
        ...
        <div class="search-buttons">
            ...
            <?php echo Form::submit('execution', '確　　定', array('class' => 'buttonB', 'style' => 'margin-right: 20px;', 'onclick' => 'return submitChkExecution()', 'tabindex' => '901')); ?>
