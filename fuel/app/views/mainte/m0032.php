<section id="banner" style="padding-top:20px;">
    <div class="content" style="margin-top:0px;">
            ...
            <table class="search-area" style="height: 90px; width: 780px">
                <tr>
                    ...
                    <td style="width: 640px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'text', 'id' => 'storage_depth_name', 'style' => 'width:620px;', 'minlength' => '1', 'maxlength' => '60', 'tabindex' => '1')); ?>
                    </td>
                </tr>
            </table>
        ...
        <?php echo Form::hidden('storage_depth_id', '');?>
                      ...
                      <?php foreach ($list_data as $key => $val) : ?>
                        ...
                        <tr>
                            <td style="width: 100px; text-align: center;">
                                <button type="button" onclick="onDelete(<?php echo $val['storage_depth_id']; ?>, '<?php echo $val['del_flg']; ?>')" class="buttonA"><i class='fa fa-trash' style="font-size:15px;"></i><?php echo $mark; ?></button>
                            </td>
                            <td style="width: 80px"><?php echo $val['storage_depth_id']; ?></td>
                            <td style="width: 540px"><?php echo $val['storage_depth_name']; ?></td>
                        </tr>
                      <?php endforeach; ?>
                    <?php endif ; ?>
                </table>
