<section id="banner" style="padding-top:20px;">
	<div class="content" style="margin-top:0px;">
        ...
        <?php echo Asset::js('mainte/m0024.js');?>
        <script>
			...
			<table class="search-area" style="height: 90px; width: 780px">
				<tr>
					...
					<td style="width: 480px; height: 30px;">
                        ...
                        <?php echo Form::label('自動採番', 'ClientR1'); ?>
                        <br />
                        ...
                        &emsp;
                        <?php echo Form::input('text_client_code', (!empty($data['client_code'])) ? $data['client_code'] : '', 
	                    array('class' => 'input-text', 'type' => 'text', 'id' => 'text_client_code', 'style' => 'width:100px;', 'minlength' => '1', 'maxlength' => '5', 'tabindex' => '5')); ?>
...
<!--				<tr>
				...
				<tr>
					...
					<td style="width: 480px; height: 30px;">
                        <?php echo Form::label((!empty($data['client_company_name'])) ? $data['client_company_name']:'', 'client_company_name', array('style' => 'display:inline;')); ?>
                        <?php echo Form::hidden('client_company_name', (!empty($data['client_company_name'])) ? $data['client_company_name'] : '');?>
					</td>
				</tr>
<!--				<tr>
					<td style="width: 140px; height: 30px;">
				...
				<tr>
					...
					<td style="width: 480px; height: 30px;">
                        <?php echo Form::label((!empty($data['client_sales_office_name'])) ? $data['client_sales_office_name']:'', 'client_sales_office_name', array('style' => 'display:inline;')); ?>
	                    <?php echo Form::hidden('client_sales_office_name', (!empty($data['client_sales_office_name'])) ? $data['client_sales_office_name'] : '');?>
					</td>
				</tr>
<!--				<tr>
					<td style="width: 140px; height: 30px;">
				...
				<tr>
					...
					<td style="width: 480px; height: 30px;">
                        <?php echo Form::label((!empty($data['client_department_name'])) ? $data['client_department_name']:'', 'client_department_name', array('style' => 'display:inline;')); ?>
	                    <?php echo Form::hidden('client_department_name', (!empty($data['client_department_name'])) ? $data['client_department_name'] : '');?>
					</td>
				</tr>
				<tr>
					<td style="width: 140px; height: 30px;">
                ...
                <tr>
					...
					<td style="width: 480px; height: 30px;">
	                    <?php echo Form::checkbox('carrier_add', 1, empty($data['carrier_add']) ? false : true, array('id' => 'form_carrier_add', 'class' => 'text')); ?>
                        <?php echo Form::label('登録する', 'carrier_add', array('style' => 'display:inline;padding-left: 2.2em;padding-top: 0.2em;')); ?>
					</td>
				</tr>
			</table>
