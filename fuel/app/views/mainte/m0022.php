<section id="banner" style="padding-top:10px;">
    <div class="content" style="margin-top:0px;">
        ...
        <?php echo Form::hidden('l_client_sales_office_name', $data['l_client_sales_office_name']);?>
        <?php echo Asset::js('mainte/m0022.js');?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 380px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'number', 'id' => 'client_sales_office_code', 'style' => 'width:90px;', 'min' => '0', 'max' => '99999', 'tabindex' => '2', 'disabled')); ?>
                        <input type="button" id="sales_office_search" class="buttonA" value="検索" tabindex="2" onclick="salesOfficeSearch('<?php echo Uri::create('search/s0022'); ?>')" disabled/>
                        <?php echo $data['l_client_sales_office_name'];?>
                    </td>
                </tr>
            </tbody>
        </table>
