	...
	<div class="content" style="margin-top:0px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 250px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'text', 'id' => 'storage_column_name', 'style' => 'width:90px;', 'maxlength' => '5', 'tabindex' => '3')); ?></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 250px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'text', 'id' => 'storage_depth_name', 'style' => 'width:90px;', 'maxlength' => '5', 'tabindex' => '4')); ?></td>
                </tr>
                <tr>
                    <td style="width: 130px; height: 30px;">保管場所高さ</td>
                    <td style="width: 250px; height: 30px;">
                        <?php echo Form::input('storage_height_name', (!empty($data['storage_height_name'])) ? $data['storage_height_name'] : '', 
                        array('class' => 'input-text', 'type' => 'text', 'id' => 'storage_height_name', 'style' => 'width:90px;', 'maxlength' => '5', 'tabindex' => '4')); ?></td>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <?php if ($total > 0) : ?>
            ...
            <div class="table-wrap">
                <table class="table-inq" style="width: 1200px">
                    <tr>
