...
<section id="banner" style="padding-top:20px;">
	<div class="content" style="margin-top:0px;">
        ...
        <table class="search-area" style="width: 380px">
            <tbody>
                <tr>
                    <td style="width: 130px; height: 30px;">庸車先コード</td>
                    <td style="width: 250px; height: 30px;">
                        <?php echo Form::input('carrier_code', (!empty($data['carrier_code'])) ? $data['carrier_code'] : '', 
                        array('class' => 'input-text', 'type' => 'number', 'id' => 'carrier_code', 'style' => 'width:90px;', 'min' => '0', 'max' => '99999', 'tabindex' => '1')); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width: 130px; height: 30px;">会社区分</td>
                    <td style="width: 250px; height: 30px;">
                        <?php echo Form::select('company_section', $data['company_section'], $company_section_list,
                        array('class' => 'select-item', 'id' => 'company_section', 'style' => 'width: 70px', 'tabindex' => '6')); ?></td>
                </tr>
                <tr>
                    <td style="width: 130px; height: 30px;">正式名称</td>
                    <td style="width: 250px; height: 30px;">
                        <?php echo Form::input('official_name', (!empty($data['official_name'])) ? $data['official_name'] : '', 
                        array('class' => 'input-text', 'type' => 'text', 'id' => 'official_name', 'style' => 'width:200px;', 'maxlength' => '40', 'tabindex' => '7')); ?></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 250px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'text', 'id' => 'official_name_kana', 'style' => 'width:200px;', 'maxlength' => '60', 'tabindex' => '8')); ?></td>
                </tr>
            </tbody>
        </table>
        <div class="search-buttons">
            ...
            <?php echo Form::submit('add', '新規登録', array('class' => 'buttonB', 'onclick' => 'onAdd(\''.Uri::create('mainte/m0031').'\')', 'tabindex' => '902')); ?>
        </div>
        <?php echo Form::close(); ?>
        <br />
        <?php echo Form::open(array('id' => 'selectForm', 'name' => 'selectForm', 'action' => '', 'method' => 'post', 'class' => 'form-stacked','enctype'=>"multipart/form-data")); ?>
        <?php echo Form::hidden('processing_division', '');?>
        <?php echo Form::hidden('carrier_code', '');?>
        <?php echo Form::hidden('select_record', '');?>
        <?php echo Form::hidden(\Config::get('security.csrf_token_key'), \Security::fetch_token());?>
        <?php if ($total > 0) : ?>
                      ...
                      <?php foreach ($list_data as $key => $val) : ?>
                        ...
                        <tr>
                            <td style="width: 60px; text-align: center;">
                                <button type="button" onclick="onEdit('<?php echo Uri::create('mainte/m0035'); ?>', <?php echo $val['carrier_code']; ?>)" class="buttonA"><i class='fa fa-edit' style="font-size:14px;"></i> 編集</button>
                                <button type="button" onclick="onDelete(<?php echo $val['carrier_code']; ?>)" class="buttonA"><i class='fa fa-trash' style="font-size:15px;"></i> 削除</button>
                            </td>
                            ...
                            <td style="width: 80px"><?php echo $company_section_list[$val['company_section']]; ?></td>
