<section id="banner" style="padding-top:10px;">
    <div class="content" style="margin-top:0px;">
        ...
        <?php echo Form::hidden('l_carrier_company_name', $data['l_carrier_company_name']);?>
        <?php echo Asset::js('mainte/m0031.js');?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 380px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'number', 'id' => 'carrier_company_code', 'style' => 'width:90px;', 'min' => '0', 'max' => '99999', 'tabindex' => '2', 'disabled')); ?>
                        <input type="button" id="company_search" class="buttonA" value="検索" tabindex="2" onclick="companySearch('<?php echo Uri::create('search/s0031'); ?>')" disabled/>
                        <?php echo $data['l_carrier_company_name'];?>
                    </td>
                </tr>
            </tbody>
        </table>
