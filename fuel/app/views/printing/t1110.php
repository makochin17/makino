<section id="banner" style="padding-top:10px;">
    <div class="content" style="margin-top:0px;">
        ...
        <?php echo Asset::js('printing/t1110.js');?>
        <p class="error-message-head" id="error_message"><?php echo $error_message; ?></p>
        <label>■出力条件</label>
        <table class="search-area" style="width: 380px">
            <tbody>
                ...
                <tr>
                    <td style="width: 150px; height: 30px;">地区</td>
                    <td style="width: 380px; height: 30px;">
                        <?php echo Form::select('area_code', $data['area_code'], $area_list,
                        array('class' => 'select-item', 'id' => 'area_code', 'style' => 'width: 150px', 'tabindex' => '1')); ?>
                        <br />※帳票種別にて「共配便」を選択時のみ指定できます
                    </td>
                </tr>
                <tr>
                    <td style="width: 150px; height: 30px;">帳票種別</td>
                    <td style="width: 380px; height: 30px;">
                        <?php echo Form::radio('report_radio', 1, $data['report_radio'] != '2', 
                        array('id' => 'form_ReportR1', 'onchange' => 'change()')); ?>
                        <?php echo Form::label('集計表', 'ReportR1'); ?>
                        <br />
                        <?php echo Form::radio('report_radio', 2, $data['report_radio'] == '2', 
                        array('id' => 'form_ReportR2', 'onchange' => 'change()')); ?>
                        <?php echo Form::label('明細表', 'ReportR2'); ?>
                        &emsp;
                        <?php echo Form::select('bill_report', $data['bill_report'], $bill_report_list,
                        array('class' => 'select-item', 'id' => 'bill_report', 'style' => 'width: 150px', 'tabindex' => '1')); ?>
                    </td>
                </tr>
            </tbody>
        </table>
        <div class="search-buttons">
            <?php echo Form::submit('output', '出力', array('class' => 'buttonB', 'style' => 'margin-right: 20px;', 'onclick' => 'message_clear()', 'tabindex' => '900')); ?>
        </div>
        <?php echo Form::close(); ?>
    </div>
</section>