<section id="banner" style="padding-top:10px;">
    <div class="content" style="margin-top:0px;">
        ...
        <script>
            ...
            var processing_msg1 = '<?php echo Config::get('m_DE0007'); ?>';
        </script>
        ...
        <div style="width: 1600px;">
            <p class="error-message-head">
                <?php echo $list_error_message; ?>
                <?php echo (!empty($list_error_message_sub)) ? $list_error_message_sub:''; ?>
            </p>
            ...
            <div class="content-row">
                ...
                <button type="button" onclick="onDeliveryFix()" class="buttonA" style="width:180px;margin-left: 30px;">　出庫確定　</button>
            </div>
        </div>
            <!-- ここまでPager -->
            <div class="table-wrap" style="clear: right">
                <table class="table-inq" style="width: 1600px;">
                    <tr>
                        ...
                        <th style="width: 100px;font-size: 13px;">タイヤ種別</th>
                      ...
                      <?php foreach ($list_data as $key => $val) : ?>
                        ...
                        <tr>
                            <td rowspan="2" style="text-align: center;">
                                <?php echo Form::checkbox('select_'.$i, $val['logistics_id'], ($val['delivery_flg'] == 'YES') ? true:false, array('id' => 'form_select_'.$i, 'class' => 'text', 'style' => 'display:inline;')); ?>
                            ...
                            <td style="font-size: 13px;text-align:left;padding-left:10px;">
                                <?php if (!empty($val['delivery_date'])) : ?>
                                    <?php $d                = new DateTime($val['delivery_date']); ?>
                                    <?php $delivery_date    = $d->format('Y-m-d'); ?>
                                    <?php echo Form::input('delivery_date_'.$i, $delivery_date, array('type' => 'date', 'id' => 'delivery_date_'.$i,'style' => 'width: 140px;','class' => 'input-date','maxlength' => '20')); ?>
                                <?php endif ; ?>
                            </td>
                            <td style="font-size: 13px;text-align:left;padding-left:10px;">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 13px;padding-left:10px;">
                                <?php if (!empty($val['delivery_time']) && $val['delivery_time'] != '00:00') : ?>
                                    <?php echo Form::input('delivery_time_'.$i, $val['delivery_time'], array('type' => 'time', 'id' => 'delivery_time_'.$i,'style' => 'width: 140px;','class' => 'input-date','maxlength' => '20')); ?>
                                <?php endif ; ?>
                            </td>
