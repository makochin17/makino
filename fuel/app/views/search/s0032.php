            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 250px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'number', 'id' => 'carrier_sales_office_code', 'style' => 'width:90px;', 'min' => '0', 'max' => '99999', 'tabindex' => '1')); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 250px; height: 30px;">
                        <?php echo Form::input('carrier_company_code', (!empty($data['carrier_company_code'])) ? $data['carrier_company_code'] : '', 
                        array('class' => 'input-text', 'type' => 'number', 'id' => 'carrier_company_code', 'style' => 'width:90px;', 'min' => '0', 'max' => '99999', 'tabindex' => '1')); ?></td>
                </tr>
            </tbody>
        </table>
                    ...
                    <?php if (!empty($list_data)) : ?>
                      <?php foreach ($list_data as $key => $val) : ?>
                        <tr>
                            ...
                            <?php echo Form::hidden('select_code', $val['carrier_sales_office_code']);?>
                            <?php echo Form::hidden(\Config::get('security.csrf_token_key'), \Security::fetch_token());?>
                            <?php echo Form::close(); ?></td>
                            <td style="width: 120px"><?php echo sprintf('%05d', $val['carrier_sales_office_code']); ?></td>
                            <td style="width: 160px"><?php echo $val['sales_office_name']; ?></td>
                            <td style="width: 120px"><?php echo sprintf('%05d', $val['carrier_company_code']); ?></td>
