            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 250px; height: 30px;">
                        ...
                        array('class' => 'select-item', 'id' => 'company_section', 'style' => 'width: 70px', 'tabindex' => '2')); ?></td>
                </tr>
                <tr>
                    <td style="width: 130px; height: 30px;">会社名</td>
                    <td style="width: 250px; height: 30px;">
                        <?php echo Form::input('company_name', (!empty($data['company_name'])) ? $data['company_name'] : '', 
                        array('class' => 'input-text', 'type' => 'text', 'id' => 'company_name', 'style' => 'width:130px;', 'maxlength' => '8', 'tabindex' => '3')); ?></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 250px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'text', 'id' => 'sales_office_name', 'style' => 'width:90px;', 'maxlength' => '5', 'tabindex' => '4')); ?></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 250px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'text', 'id' => 'department_name', 'style' => 'width:90px;', 'maxlength' => '5', 'tabindex' => '5')); ?></td>
                </tr>
                <tr>
                    <td style="width: 130px; height: 30px;">締日</td>
                    <td style="width: 250px; height: 30px;">
                        <?php echo Form::select('closing_date', $data['closing_date'], $closing_date_list,
                        array('class' => 'select-item', 'id' => 'closing_date', 'style' => 'width: 90px', 'tabindex' => '6')); ?>
                    日</td>
                </tr>
                <tr>
                    ...
                    <?php if (!empty($list_data)) : ?>
                      <?php foreach ($list_data as $key => $val) : ?>
                        ...
                        <tr>
                            ...
                            <?php echo Form::hidden('select_code', $val['carrier_code']);?>
                            <?php echo Form::hidden(\Config::get('security.csrf_token_key'), \Security::fetch_token());?>
