<section id="banner" style="padding-top:10px;">
    <div class="content" style="margin-top:0px;">
        ...
        <div style="width: 900px;">
            ...
            <div class="content-row">
                <button type="button" onclick="onJump('<?php echo Uri::create('location/l0010'); ?>', '', '', '')" class="buttonA">　倉庫に戻る　</button>
            </div>
        </div>
            ...
            <table class="table-inq" style="width: 900px;">
                ...
                <?php if (!empty($list_data)) : ?>
                  <?php foreach ($list_data as $key => $val) : ?>
                    <tr>
                        <td style="text-align:left;padding-left:10px;" onclick="onJump('<?php echo Uri::create('location/l0012'); ?>', '<?php echo $warehouse_id; ?>', '<?php echo $val['storage_column_id']; ?>', '')">
