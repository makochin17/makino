<section id="banner" style="padding-top:20px;">
	<div class="content" style="margin-top:0px;">
        ...
        <?php echo Form::hidden('mode', (!empty($data['mode'])) ? $data['mode']:2); ?>
        ...
        <br />
			<table class="search-area" style="height: 90px; width: 680px">
				...
				<tr>
					...
					<td style="width: 480px; height: 30px;">
				        <?php echo (!empty($data['office_name'])) ? $data['office_name']:''; ?>
						<?php echo Form::hidden('office_name', (!empty($data['office_name'])) ? $data['office_name']:''); ?>
	                    <?php // echo Form::input('office_name', (!empty($data['office_name'])) ? $data['office_name'] : '', array('class' => 'input-text', 'type' => 'text', 'id' => 'office_name', 'style' => 'width:300px;', 'minlength' => '1', 'maxlength' => '50', 'tabindex' => '12')); ?>
					</td>
				</tr>
				<tr>
					<td style="width: 200px; height: 30px;">
					...
					<td style="width: 480px; height: 30px;">
	                    <?php echo Form::input('manager_name', (!empty($data['manager_name'])) ? $data['manager_name'] : '', array('class' => 'input-text', 'type' => 'text', 'id' => 'manager_name', 'style' => 'width:300px;', 'minlength' => '1', 'maxlength' => '50', 'tabindex' => '13')); ?>
					</td>
				</tr>
				<tr>
					<td style="width: 200px; height: 30px;">
