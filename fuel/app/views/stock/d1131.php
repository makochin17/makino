<main class="l-main">
  ...
  <?php echo Form::hidden('storage_fee_number', (!empty($data['storage_fee_number'])) ? $data['storage_fee_number']:'', array('id' => 'hidden_storage_fee_number'));?>
    ...
    <div class="content-row">
      ...
      <input type="button" name="search" value="保管料履歴引用" class='buttonB' tabindex="800" onclick="onDispatchCharterSearch('<?php echo Uri::create('search/s1030'); ?>', 0)" style="margin-left: 60px;" />
