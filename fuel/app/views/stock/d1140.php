<main class="l-main">
    ...
    <table class="search-area" style="width: 680px">
      <tbody>
        ...
        <tr>
          ...
          <td style="width: 480px; height: 30px;">
            <?php echo Form::input('client_code', (!empty($data['client_code'])) ? $data['client_code']:'', array('id' => 'client_code', 'class' => 'input-text', 'type' => 'number', 'style' => 'width: 100px;', 'min' => '0', 'max' => '99999','tabindex' => '4')); ?>
            <input type="button" name="s_client" value="検索" class='buttonA' tabindex="5" onclick="onClientSearch('<?php echo Uri::create('search/s0020'); ?>', 0)" />
          </td>
        </tr>
        <tr>
          <td style="width: 200px; height: 30px;">
          ...
          <td style="width: 480px; height: 30px;">
            <?php echo Form::input('storage_location', (!empty($data['storage_location'])) ? $data['storage_location']:'', array('class' => 'input-text', 'id' => 'storage_location', 'style' => 'width: 300px;', 'maxlength' => '15', 'tabindex' => '6')); ?>
          </td>
        </tr>
        <tr>
          <td style="width: 200px; height: 30px;">
        ...
        <tr>
          ...
          <td style="width: 480px; height: 30px;">
            <?php echo Form::input('maker_name', (!empty($data['maker_name'])) ? $data['maker_name']:'', array('class' => 'input-text', 'id' => 'maker_name', 'style' => 'width: 300px;', 'maxlength' => '15', 'tabindex' => '8')); ?>
          </td>
        </tr>
        <tr>
          <td style="width: 200px; height: 30px;">
          ...
          <td style="width: 480px; height: 30px;">
            <?php echo Form::input('part_number', (!empty($data['part_number'])) ? $data['part_number']:'', array('class' => 'input-text', 'id' => 'part_number', 'style' => 'width: 300px;', 'maxlength' => '15', 'tabindex' => '8')); ?>
          </td>
        </tr>
        <tr>
          <td style="width: 200px; height: 30px;">
          ...
          <td style="width: 480px; height: 30px;">
            <?php echo Form::input('model_number', (!empty($data['model_number'])) ? $data['model_number']:'', array('class' => 'input-text', 'id' => 'model_number', 'style' => 'width: 300px;', 'maxlength' => '15', 'tabindex' => '8')); ?>
          </td>
        </tr>
        <tr>
          <td style="width: 200px; height: 30px;">
          ...
          <td style="width: 460px; height: 30px;">
            <?php echo Form::select('create_user', $data['create_user'], $create_user_list, array('class' => 'select-item', 'id' => 'create_user', 'style' => 'width: 180px', 'tabindex' => '9')); ?></td>
        </tr>
      </tbody>
    </table>
  ...
  <form action="" class="formBody">
    ...
    <div class="table-wrap" style="clear: right">
        <table class="table-inq" style="width: 1260px;">
            <tr>
