                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: right;">
                      <?php echo floatval(number_format(!empty($data['list'][$i]['total_volume']) ? $data['list'][$i]['total_volume']:'0.00', 6)); ?>
                      <?php echo Form::hidden('list['.$i.'][total_volume]', (!empty($data['list'][$i]['total_volume'])) ? $data['list'][$i]['total_volume']:'0.00', array('id' => 'total_volume_'.$i));?>
                    </td>
                    <?php /* 単位 */ ?>
                    <td>
                      <?php echo (isset($unit_list[$data['list'][$i]['unit_code']]) && !empty($unit_list[$data['list'][$i]['unit_code']])) ? $unit_list[$data['list'][$i]['unit_code']]:''; ?>
                      <?php echo Form::hidden('list['.$i.'][unit_code]', (!empty($data['list'][$i]['unit_code'])) ? $data['list'][$i]['unit_code']:'1', array('id' => 'unit_code_'.$i));?>
                    </td>
                    <?php /* 備考 */ ?>
                    <td>
