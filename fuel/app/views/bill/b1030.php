...
<section id="banner" style="padding-top:10px;">
    <div class="content" style="margin-top:0px;">
        ...
        <?php echo Asset::js('common/jquery.cookie.js');?>
        <?php echo Asset::js('bill/b1030.js');?>
        <script>
            ...
            var error_msg1 = '<?php echo Config::get('m_CE0001'); ?>';
        </script>
        ...
        <div class="search-buttons">
            ...
            <?php echo Form::button('back', '戻る', array('type' => 'button', 'class' => 'buttonB', 'id' => 'dispatch_back', 'tabindex' => '101')); ?>
        </div>
        <?php echo Form::close(); ?>
        <br />
        <?php if ($total > 0) : ?>
        <div style="width: 1650px;">
            ...
            <!-- ここまでPager -->
            <div class="search-buttons">
                <?php echo Form::button('select_out', '選択したものを出力', array('id' => 'select_out', 'class' => 'buttonB', 'style' => 'margin-right: 20px;', 'tabindex' => '100')); ?>
                <?php echo Form::button('search_out', '検索したものを出力', array('id' => 'search_out', 'class' => 'buttonB', 'style' => 'margin-right: 20px;', 'tabindex' => '101')); ?>
                <?php echo Form::button('org_out', '空の雛形を出力', array('id' => 'org_out', 'class' => 'buttonB', 'style' => 'margin-right: 20px;', 'tabindex' => '102')); ?>
            </div>
                      ...
                      <?php foreach ($list_data as $key => $val) : ?>
                        ...
                        <tr>
                            <td rowspan="2" style="width: 60px; text-align: center;">
                                <?php echo Form::checkbox('rec_select['.$i.']', (isset($rec_select[$val['dispatch_number']])) ? $val['dispatch_number']:'', (isset($rec_select[$val['dispatch_number']])) ? true:false, array('id' => 'form_rec_select_'.$i, 'class' => 'text', 'style' => 'display:inline;')); ?>
                                <?php echo Form::label('', 'rec_select_'.$i, array('style' => 'display:inline;padding-left: 1.0em;')); ?>
                                <?php echo Form::hidden('select_dispatch_number_'.$i, $val['dispatch_number'], array('id' => 'select_dispatch_number_'.$i));?>
                            </td>
