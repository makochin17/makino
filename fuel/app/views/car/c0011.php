        ...
        <br />
			<table class="search-area" style="height: 90px; width: 900px">
				...
				<tr>
                    ...
                    array('class' => 'input-text', 'type' => 'text', 'id' => 'note', 'style' => 'width:600px;', 'minlength' => '1', 'maxlength' => '100', 'tabindex' => '41')); ?>
					</td>
				</tr>
				<tr>
					<td style="width: 200px; height: 30px;">
                    ...
                    array('class' => 'input-text', 'type' => 'text', 'id' => 'message', 'style' => 'width:600px;', 'minlength' => '1', 'maxlength' => '100', 'tabindex' => '42')); ?>
					</td>
				</tr>
			</table>
			<br />
