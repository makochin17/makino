<section id="banner" style="padding-top:10px;">
    <div class="content" style="margin-top:0px;">
        ...
        <?php echo Asset::js('summary/t0030.js');?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 380px; height: 30px;">
                        ...
                        array('class' => 'input-text', 'type' => 'number', 'id' => 'carrier_code', 'style' => 'width:100px;', 'min' => '0', 'max' => '99999', 'tabindex' => '2', 'disabled')); ?>
                        <input type="button" id="carrier_search" class="buttonA" value="検索" tabindex="2" onclick="clientSearch('<?php echo Uri::create('search/s0030'); ?>')" disabled/>
                    </td>
                </tr>
                <tr>
