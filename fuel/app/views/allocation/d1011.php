...
<main class="l-main">
  ...
  <?php echo Form::hidden('dispatch_number', (!empty($data['dispatch_number'])) ? $data['dispatch_number']:'', array('id' => 'hidden_dispatch_number'));?>
    ...
    <div class="content-row">
      ...
      <input type="button" name="search" value="配車履歴引用" class='buttonB' tabindex="800" onclick="onDispatchCharterSearch('<?php echo Uri::create('search/s1010'); ?>', 0)" style="margin-left: 60px;" />
