<main class="l-main">
  ...
  <?php echo Form::hidden('sales_correction_number', (!empty($data['sales_correction_number'])) ? $data['sales_correction_number']:'', array('id' => 'hidden_sales_correction_number'));?>
    <script>
    ...
    <div class="content-row" style="margin-bottom: 20px;">
      ...
      <?php echo Form::select('processing_division', $data['processing_division'], $processing_division_list,
          array('class' => 'select-item', 'id' => 'processing_division', 'onchange' => 'return submitChengeProcessingDivision()', 'tabindex' => '1')); ?>
      <?php */ ?>
