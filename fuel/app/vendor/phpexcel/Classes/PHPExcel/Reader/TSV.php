 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Reader_TSV extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	/**
	 * Input encoding
	 *
	...
	/**
	 * Create a new PHPExcel_Reader_TSV
	 */
	...
	/**
	 * Validate that the current file is a TSV file
	 *
	 * @return boolean
	 */
