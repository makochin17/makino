 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Writer_TSV extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter {
	/**
	 * PHPExcel object
	 *
	 * @var PHPExcel
	...
	/**
	 * Whether to write a fully Excel compatible TSV file.
	 *
	 * @var boolean
	 */
	...
	/**
	 * Create a new PHPExcel_Writer_TSV
	 *
	...
	private function _writeLine($pFileHandle = null, $pValues = null) {
		if (is_array($pValues)) {
			...
			throw new PHPExcel_Writer_Exception("Invalid data row passed to TSV writer.");
		}
	}
