...
class Controller_Car_C0011 extends Controller_Hybrid {
    ...
    **/
	private function initViewForge($auth_data){
        ...
        $cnf['header_title']                = '車両情報登録';
        $cnf['page_id']                     = '[C0011]';
        $cnf['tree']['top']                 = \Uri::base(false);
        $cnf['tree']['management_function'] = '車両情報登録';
    ...
    public function action_index() {
        ...
        if (!empty(Input::param('input_clear')) && Input::method() == 'POST' && Security::check_token()) {
            ...
            // 確定ボタンが押下された場合の処理
            $conditions = C0011::setForms('car', $conditions, Input::param());
        ...
        $this->template->content = View::forge(AccessControl::getActiveController(),
            array(
                ...
                'check_url'                 => \Uri::create('car/c0011/chcarid'),
    ...
    **/
    public function action_chcarid() {
        ...
        if (!C0011::getCar($car_id, C0011::$db)) {
            $res    = 0;
        }
