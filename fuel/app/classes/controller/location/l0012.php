...
class Controller_Location_L0012 extends Controller_Hybrid {
    ...
    **/
    ...
    public function action_index() {
        ...
        $storage_list   = L0010::getLocationDepth($warehouse_id, $column_id, L0010::$db);

        if (!empty($storage_list)) {
            foreach ($storage_list as $key => $val) {
                $list_data[] = array(
                    'depth_cnt'                 => $val['depth_cnt'],
                    'storage_depth_id'          => $val['storage_depth_id'],
                    'storage_depth_name'        => $val['storage_depth_name'],
                    'stock_cnt'                 => L0010::getLocationDetail('count', $warehouse_id, $column_id, $val['storage_depth_id'], null, L0010::$db),
                );
            }
        }
