...
class Controller_Location_L0013 extends Controller_Hybrid {
    ...
    **/
    ...
    public function action_index() {
        ...
        $storage_list   = L0010::getLocationHeight($warehouse_id, $column_id, $depth_id, L0010::$db);

        if (!empty($storage_list)) {
            foreach ($storage_list as $key => $val) {
                $detail_data        = L0010::getLocationDetail('search', $warehouse_id, $column_id, $depth_id, $val['storage_height_id'], L0010::$db);
