...
class Controller_Location_L0011 extends Controller_Hybrid {
    ...
    **/
    ...
    public function action_index() {
        ...
        $storage_list   = L0010::getLocationColumn($warehouse_id, L0010::$db);
        ...
        if (!empty($storage_list)) {
            foreach ($storage_list as $key => $val) {
                $list_data[] = array(
                    ...
                    'stock_cnt'                 => L0010::getLocationDetail('count', $warehouse_id, $val['storage_column_id'], null, null, L0010::$db),
                );
            }
        }
