...
class Controller_Allocation_D1011 extends Controller_Hybrid {
    ...
    **/
    ...
    public function action_index() {
        ...
        if (!empty(Input::param('input_clear')) && Input::method() == 'POST' && Security::check_token()) {
             ...
             */
            Session::delete('d1011_list');
            Session::set('d1011_list', $conditions);
        } else {
            $conditions = D1011::setForms('dispatch', $conditions, Input::param());
            if ($cond = Session::get('d1011_list', array())) {
                $conditions = $cond;
                Session::delete('d1011_list');
            }
