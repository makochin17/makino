...
class Controller_Allocation_D0032 extends Controller_Hybrid {
...
//                    ->add_rule('required')
    ...
    public function action_index() {
        ...
        $sales_correction_number    = Input::param('sales_correction_number', '');
        ...
        if (!empty(Input::param('input_clear')) && Input::method() == 'POST' && Security::check_token()) {
             ...
             */
            Session::delete('d0032_list');
            Session::set('d0032_list', $conditions);
        } else {
            $conditions = D0030::setForms($conditions, Input::param());
            if ($cond = Session::get('d0032_list', array())) {
                $conditions = $cond;
                Session::delete('d0032_list');
            }
            ...
            if (!empty($sales_correction_number)) {
                Session::set('select_sales_correction_number', $sales_correction_number);
            }
