...
class Controller_Schedule_S0010 extends Controller_Hybrid {
    ...
    **/
    private function initViewForge($auth_data){
        ...
        // ユニットリスト
        $this->unit_list                = GenerateList::getUnitList('all', S0010::$schedule_type, true, S0010::$db);
        // 依頼区分リスト
    ...
    public function action_index() {
        ...
        $this->template->content = View::forge(AccessControl::getActiveController(),
            array(
                ...
                // ユニットリストデータ
                'unit'                      => S0010::setList('unit', S0010::getUnit(null, S0010::$schedule_type, true, S0010::$db)),
