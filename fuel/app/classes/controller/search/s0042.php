...
class Controller_Search_S0042 extends Controller_Hybrid {
    ...
    **/
    ...
    public function action_index() {
        ...
        $storage_list   = S0040::getLocationDepth($warehouse_id, $column_id, S0040::$db);
        ...
        if (!empty($storage_list)) {
            foreach ($storage_list as $key => $val) {
                $list_data[] = array(
                    ...
                    'stock_cnt'                 => S0040::getLocationDetail('count', $warehouse_id, $column_id, $val['storage_depth_id'], null, S0040::$db),
                );
            }
        }
