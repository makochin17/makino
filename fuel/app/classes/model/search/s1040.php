...
class S1040 extends \Model {
    ...
    //=========================================================================//
    /**
     * 請求レコード検索 & 請求レコード検索件数取得
     */
    public static function getbillShare($type = 'search', $conditions, $offset, $limit, $db = null) {
        ...
        switch ($type) {
            case 'count':
                ...
                break;
            case 'export':
                return $stmt->order_by('t.destination_date', 'ASC')
                    ->execute($db)
                    ->as_array();
                break;
            case 'search':
    ...
    public static function getSearchCount($conditions, $db) {
        return self::getbillShare('count', $conditions, null, null, $db);
    }
    ...
    public static function getSearch($conditions, $offset, $limit, $db) {
        return self::getbillShare('search', $conditions, $offset, $limit, $db);
    }
