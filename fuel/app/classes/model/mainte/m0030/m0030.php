...
class M0030 extends \Model {
     ...
     * 保管場所リレーションレコード取得
     */
    public static function getStorageLocationBySubCode($storage_column_id, $storage_depth_id, $storage_height_id, $db) {
    ...
    public static function getBody($conditions, $db) {
        ...
        foreach ($storage_location_list as $location) {
            ...
            $record = array(
                ...
                'storage_location_name' => $carrier['storage_location_name'],
                'storage_column_id'     => $carrier['storage_column_id'],
                'storage_column_name'   => $carrier['storage_column_name'],
                'storage_depth_id'      => $carrier['storage_depth_id'],
                'storage_depth_name'    => $carrier['storage_depth_name'],
                'storage_height_id'     => $carrier['storage_height_id'],
                'storage_height_name'   => $carrier['storage_height_name'],
            );
