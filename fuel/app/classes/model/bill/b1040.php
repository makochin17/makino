        ...
        switch ($type) {
            ...
            default:
                $stmt = \DB::select(
                            ...
                            array(\DB::expr('(SELECT GROUP_CONCAT(LPAD(dispatch_number, 10, "0")) FROM t_bill_share_link WHERE bill_number = t.bill_number GROUP BY bill_number)'), 'dispatch_number'),
