...
return array(
	...
	'groups' => array(
		 ...
		 */
		 0 	=> array('name' => 'Super', 		'roles' => array('user', 'leader', 'manager', 'admin', 'super')),
		 1  => array('name' => 'システム管理者', 	'roles' => array('user', 'leader', 'manager', 'admin')),
		 2  => array('name' => '管理職', 		'roles' => array('user', 'leader', 'manager')),
		 3  => array('name' => '業務管理者', 		'roles' => array('user', 'leader')),
		 4  => array('name' => '一般', 			'roles' => array('user')),
	),
	 ...
	 */
	'login_hash_salt' => 'kobayashi',

	/**
	 * $_POST key for login username
	 */
	// 'username_post_key' => 'mail_address',
